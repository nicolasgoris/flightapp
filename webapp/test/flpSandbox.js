		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight app",
									"targetURL": "#edubeapflightzsd000flight-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"edubeapflightzsd000flight-display": {
								"semanticObject": "edubeapflightzsd000flight",
								"action": "display",
								"description": "A Fiori application to check the flights",
								"title": "Flight app",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=edu.be.ap.flight.zsd000flight",
									"url": sap.ui.require.toUrl("edu/be/ap/flight/zsd000flight")
								}
							}
						}
					}
